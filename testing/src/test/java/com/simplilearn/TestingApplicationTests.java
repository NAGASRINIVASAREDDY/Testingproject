...
class ApplicationTests {
	...
	void addStudent() {
		...
		driver.get("http://localhost:8085/index");
		sleep(1000);
		driver.manage().window().maximize();
		driver.findElement(By.className("btn-success")).click();
		sleep(1000);
		driver.findElement(By.xpath("//input[@type='text']")).sendKeys("reddy");
		sleep(1000);
		driver.findElement(By.xpath("//input[@type='email']")).sendKeys("reddy@gmail.com");
		sleep(1000);
	...
	void updateStudent() {
		...
		sleep(1000);
		driver.findElement(By.xpath("//input[@type='text']")).sendKeys("srinu");
		sleep(1000);
		driver.findElement(By.xpath("//input[@type='email']")).sendKeys("srinu@gmail.com");
		sleep(1000);
